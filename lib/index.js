...
export const SECTIONS = ['home', 'about', 'projects', 'technologies', 'contact'];

export const FACEBOOK = 'https://www.facebook.com/ratanak.serey/';

export const LINKEDIN = 'https://www.linkedin.com/in/serey-roth/';

export const GITHUB = 'https://github.com/serey-roth';
